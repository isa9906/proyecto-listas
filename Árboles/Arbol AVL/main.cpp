...
int main(int argc, char** argv) {
	...
	cin>>max;
	arbolAVL <int> arbol (max);
	while(c!=0){
		system("cls");
		//menu
		cout<<endl<<"1. Insertar un elemento"<<endl<<"2. Eliminar un elemento"<<endl<<"3. Recorrido in orden"<<endl<<"4. Recorrido pre orden"<<endl<<"5. Recorrido pos orden"
		<<endl<<"6. Ver estructura del arbol y factores de desequilibrio"<<endl<<"Opcion: ";
		cin>>opcion;
		switch(opcion){
